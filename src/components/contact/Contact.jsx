...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_3b375h9', 'template_0w0i9eu', formRef.current, {
        publicKey: 'tJfel5urXIRRTAa3g',
      })
      .then(
        () => {
          setSuccess(true)
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>neerajkr145518@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>Hello street Chapra</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>91+7520439835</span>
        </motion.div>
      </motion.div>
      <div className="formContainer">
        ...
        >
          <svg className="svg" height="450px" width="450px" viewBox="0 0 512 512">
            <motion.path
              stroke-width={0.2}
              fill="none"
